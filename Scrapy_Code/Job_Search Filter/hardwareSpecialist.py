...
class HardwareSpecialistSpider(scrapy.Spider):
    name = "hardwareSpecialist"
    allowed_domains = ["seek.com.au"]
    start_urls = ['https://www.seek.com.au/jobs-in-information-communication-technology/engineering-hardware/in-All-Brisbane-QLD']
