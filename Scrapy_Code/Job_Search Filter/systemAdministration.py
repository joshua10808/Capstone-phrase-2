...
class SystemAdministrationSpider(scrapy.Spider):
    name = "systemAdministration"
    allowed_domains = ["seek.com.au"]
    start_urls = ['https://www.seek.com.au/jobs-in-information-communication-technology/networks-systems-administration/in-All-Brisbane-QLD']
