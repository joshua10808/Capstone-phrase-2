...
class ComputationalAndSimulationScienceSpider(scrapy.Spider):
    name = "computationalAndSimulationScience"
    allowed_domains = ["seek.com.au"]
    start_urls = ['https://www.seek.com.au/jobs-in-information-communication-technology/in-All-Brisbane-QLD?subclassification=6287%2C6290%2C6303']
