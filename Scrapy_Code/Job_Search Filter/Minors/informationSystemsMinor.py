...
class InformationSystemsMinorSpider(scrapy.Spider):
    name = "informationSystemsMinor"
    allowed_domains = ["seek.com.au"]
    start_urls = ['https://www.seek.com.au/jobs-in-information-communication-technology/in-All-Brisbane-QLD?subclassification=6283%2C6299%2C6282']
