...
class TestersSpider(scrapy.Spider):
    name = "testers"
    allowed_domains = ["seek.com.au"]
    start_urls = ['https://www.seek.com.au/jobs-in-information-communication-technology/testing-quality-assurance/in-All-Brisbane-QLD']
