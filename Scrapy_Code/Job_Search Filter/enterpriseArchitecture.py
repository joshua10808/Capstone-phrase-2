...
class EnterpriseArchitectureSpider(scrapy.Spider):
    name = "enterpriseArchitecture"
    allowed_domains = ["seek.com.au"]
    start_urls = ['https://www.seek.com.au/jobs-in-information-communication-technology/architects/in-All-Brisbane-QLD']
